...
@Tag(name = "Categoria", 
	 description = "Servicio que maneja un catalogo de categorias.")
@RestController
...
public class CategoriaController {
	...
	/***
	 * Metodo que me retorna una lista de categorias.
	 * Metodo HTPP tipo get
	 * @return lista.
	 */
	...
	public CategoriaDTO nuevaCategoria(
			...
			@Valid @RequestBody final CategoriaDTO categoria) {
	...
	public CategoriaDTO actualizaCategoria(
	...
	@GetMapping("/busqueda")
	public List<CategoriaDTO> busqueda(
