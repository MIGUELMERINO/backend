...
public interface ProductoRepository extends JpaRepository<Producto, Integer> {
	...
	/**
	 * Modifying ->  modifica internamente la consulta para que la tome como principal al momento de ejecutarla.
	 * Transacional -> operacion (insertar, eliminar, consultar y actualizar) que realiza hibernate para los datos.
