...
public class UserDetailsJWT extends User {
	...
	/***
	 * Metodo que crea o asigna valores a un clase User para generar la authorizacion del usuario.
	 * @param id identicador del usuario.
	 * @param email correo del usuario
	 * @param password del usuario
	 * @param authority lista de las perfiles autorizados.
	 */
	public UserDetailsJWT(final Integer id, String email, String password, 
